                        ...
                        <div class="col-12">
                            <form id="add-product-form" action="../AddProductServlet" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="textarea" rows="10" class="form-control" placeholder="Product Description" required></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="code" placeholder="Product Code #1234 e.g" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
